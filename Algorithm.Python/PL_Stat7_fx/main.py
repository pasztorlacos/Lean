...
import hp3
from eq2_ai_2 import Eq2_ai_2
from fx2_ai_2 import Fx2_ai_2
...
class MyAlgo(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.myHelpers.InstallStrategy(Eq2_ai_2, myAllocation=1.00*0.00001)
        self.myHelpers.InstallStrategy(Fx2_ai_2, myAllocation=1.00*0.99)
    ...
    def OnEndOfAlgorithm(self):
        self.MyDebug(f' signalsTotal:{self.signalsTotal}')
