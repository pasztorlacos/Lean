...
class MySIMPosition():
    ...
    useHeader=True
    subStatName="\\2000-2009_"
    statName = "Stat5_2"+subStatName
    ...
    def SaveData(cls, algo):
        ...
        for savefile in cls.saveFiles:
            shutil.copyfile(os.path.abspath(savefile[0]), cls.statFolder + datetime.now().strftime("%Y%m%d_%H_%M") + '_' + savefile[1] +'.txt')
