...
import hp3
from eq2_1 import Equities2_1
#from eq2_1_tf import Equities2_1_tf
...
class MyAlgo(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        '''STARTEGIES'''
        self.myHelpers.InstallStrategy(Equities2_1, myAllocation=0.5*1)
        #self.myHelpers.InstallStrategy(Equities2_1_tf, myAllocation=0.5*1)
